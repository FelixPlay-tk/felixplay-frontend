...
const Header = () => {
  ...
  return (
    <header
      className={`sticky top-0 h-20 w-full flex items-center px-3 lg:px-9 text-white z-10 bg-black`}
    >
      <Sidebar />
      ...
      <nav className="hidden lg:flex  mx-10 items-center flex-grow space-x-6 font-semibold tracking-widest uppercase">
        ...
        {NavData?.map((item, index) => (
          <DropDownMenu name={item.title} link={item.link} key={index}>
      ...
      <div className="flex justify-center items-center space-x-2">
        ...
        {!authLoading && isLoggedIn && (
          <div className="dropdown dropdown-hover dropdown-end">
            ...
            <ul tabIndex="0" className="menu dropdown-content w-40 ">
